...
const Login = ({ initialMode = "login" }) => {
  ...
  // Novo useEffect para monitorar mudanças na URL
  useEffect(() => {
    const isLoginPage = location.pathname === "/login";
    const isRegisterPage =
      location.pathname === "/register" || location.pathname === "/cadastro";
  ...
  // Também atualizar com base no initialMode quando o componente montar
  useEffect(() => {
