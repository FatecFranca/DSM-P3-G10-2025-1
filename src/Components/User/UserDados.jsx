...
const UserDados = () => {
    ...
    function onSubmitPassword(event) {
        event.preventDefault();
        if (password.validate() && newPassword.validate() && password.value !== newPassword.value) {
        ...
        <div className={styles.user}>
            ...
            <div className={styles.password}>
                ...
                <form onSubmit={onSubmitPassword}>
                    <Input label="Senha Atual" type="password" name="password" {...password}/>
                    <Input label="Nova Senha" type="password" name="newPassword" {...newPassword}/>
                    <Button className={styles.buttonNoFocus}>Alterar</Button>
                </form>
            </div>
        </div>
